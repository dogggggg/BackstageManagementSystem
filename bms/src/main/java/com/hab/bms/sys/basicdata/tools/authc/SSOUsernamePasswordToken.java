package com.hab.bms.sys.basicdata.tools.authc;
...
public class SSOUsernamePasswordToken {
	...
	public SSOUsernamePasswordToken(String username, String password, boolean isRememberMe) {
		upToken = new UsernamePasswordToken(username, password, isRememberMe);
	}
	 ...
	 * 
	 * @param upToken
	 *            value to be assigned to property upToken
	 */
	 ...
	 *
	 * @return the String representation of the <tt>UsernamePasswordToken</tt>,
